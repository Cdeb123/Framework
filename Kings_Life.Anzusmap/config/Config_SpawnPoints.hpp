...
*            description = "Short text shown in the custom spawn selector.";
*            advanced = 1; // Hidden until the player has completed an initial spawn.
*            spawnOffsets[] = {{0,0,0},{2,1.5,0},{-2,1.5,0}}; // Small deterministic pads around marker.
*
*/
    ...
    class Anzusmap {
        ...
        class Civilian {
            ...
            class RebelNW {
                ...
                icon = "\a3\ui_f\data\map\MapControl\bunker_ca.paa";
                spawnType = "Rebel";
                description = "Unlocked rebel outpost. Available after your initial spawn when your rebel license is active.";
                conditions = "license_civ_rebel";
                advanced = 1;
            };
            ...
            class RebelS {
                ...
                icon = "\a3\ui_f\data\map\MapControl\bunker_ca.paa";
                spawnType = "Rebel";
                description = "Southern rebel outpost. Available after your initial spawn when your rebel license is active.";
                conditions = "license_civ_rebel";
                advanced = 1;
            };
            ...
            class RebelNE {
                ...
                icon = "\a3\ui_f\data\map\MapControl\bunker_ca.paa";
                spawnType = "Rebel";
                description = "Northeast rebel outpost. Available after your initial spawn when your rebel license is active.";
                conditions = "license_civ_rebel";
                advanced = 1;
            };
        };
        ...
        class Cop {
            class NAirport {
                ...
                description = "North airport law enforcement station.";
                conditions = "";
            };
            ...
            class SWAirport {
                ...
                icon = "\a3\ui_f\data\map\MapControl\fuelstation_ca.paa";
                spawnType = "LEO Station";
                description = "Southwest airport law enforcement station.";
                conditions = "";
            };
            ...
            class Air {
                ...
                icon = "\a3\ui_f\data\map\Markers\NATO\b_air.paa";
                spawnType = "Aviation";
                description = "Police aviation headquarters for certified air units.";
                conditions = "['corporal'] call life_fnc_leoAtLeastRank && {license_cop_cAir}";
            };
        ...
        class Medic {
            ...
            class SEHospital {
                ...
                spawnMarker = "medic_spawn_1";
                icon = "\a3\ui_f\data\map\MapControl\hospital_ca.paa";
                spawnType = "EMS Station";
                description = "Southeast medical station for EMS response.";
                conditions = "";
            };
            ...
            class TanoukaHospital {
                ...
                icon = "\a3\ui_f\data\map\MapControl\hospital_ca.paa";
                spawnType = "EMS Station";
                description = "Tanouka medical station for central island coverage.";
                conditions = "";
            };
            ...
            class NEAirportHospital {
                ...
                icon = "\a3\ui_f\data\map\MapControl\hospital_ca.paa";
                spawnType = "EMS Station";
                description = "Northeast airport medical station for airfield and coastal response.";
                conditions = "";
            };
