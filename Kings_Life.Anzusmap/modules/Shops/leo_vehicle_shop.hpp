#define LEO_VEHICLE_SHOP_IDD 8800
#define LEO_VEHICLE_SHOP_TITLE 8801
#define LEO_VEHICLE_SHOP_SUBTITLE 8802
#define LEO_VEHICLE_SHOP_CATEGORIES 8803
#define LEO_VEHICLE_SHOP_VEHICLES 8804
#define LEO_VEHICLE_SHOP_DETAILS 8805
#define LEO_VEHICLE_SHOP_PICTURE 8806
#define LEO_VEHICLE_SHOP_BUY 8807
#define LEO_VEHICLE_SHOP_COLORS 8808

class life_leo_vehicle_shop {
    idd = LEO_VEHICLE_SHOP_IDD;
    movingEnable = 0;
    enableSimulation = 1;
    onLoad = "[] spawn {uiSleep 0.01; [missionNamespace getVariable ['life_vehicle_shop_type','cop_car']] call life_fnc_leoVehicleShopLoad;}";
    ...
    class controls {
        ...
        class Subtitle: Life_RscText {
            idc = LEO_VEHICLE_SHOP_SUBTITLE;
            text = "Patrol and specialty ground vehicles";
        ...
        class Categories: Life_RscListBox {
            idc = LEO_VEHICLE_SHOP_CATEGORIES;
            x = 0.182 * safezoneW + safezoneX;
            y = 0.276 * safezoneH + safezoneY;
            w = 0.122 * safezoneW;
            h = 0.414 * safezoneH;
            sizeEx = 0.026;
            onLBSelChanged = "[] call life_fnc_leoVehicleShopCategory";
        };
        class Vehicles: Life_RscListBox {
            idc = LEO_VEHICLE_SHOP_VEHICLES;
            x = 0.344 * safezoneW + safezoneX;
            y = 0.276 * safezoneH + safezoneY;
            w = 0.194 * safezoneW;
            h = 0.414 * safezoneH;
            sizeEx = 0.025;
            onLBSelChanged = "[] call life_fnc_leoVehicleShopSelect";
        };
        class Picture: Life_RscPictureKeepAspect {
            idc = LEO_VEHICLE_SHOP_PICTURE;
            text = "";
        ...
        class BuyButton: Life_RscButtonMenu {
            idc = LEO_VEHICLE_SHOP_BUY;
            text = "Purchase";
            onButtonClick = "[] call life_fnc_leoVehicleShopBuy";
            x = 0.586 * safezoneW + safezoneX;
