...
/* Database Related Settings */
    ...
    saved_virtualItems[] = { "pickaxe","fuelEmpty","fuelFull", "spikeStrip", "lockpick", "policeKeycard", "emsKeycard", "fireKeycard", "commandKeycard", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","beer","whiskey","painkillers","antidote","virusSample","apple","peach","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","defibrillator","toolkit" }; //Array of virtual items that can be saved on your player.
    ...
    save_vehicle_items[] = { "pickaxe","fuelEmpty","fuelFull", "spikeStrip", "lockpick", "policeKeycard", "emsKeycard", "fireKeycard", "commandKeycard", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","beer","whiskey","painkillers","antidote","virusSample","apple","peach","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","defibrillator","toolkit" };
...
/* System Settings */
    ...
    radial_menu_key = 59; //Default F1. Also supports Controls -> Custom Controls -> User Action 9.
    radial_menu_customAction = "User9";
    radial_menu_radius = 6;
    ...
    escapeMenu_displayText = "Thank You! Come Again!"; //Text displayed in the escape menu. Make it short.. around 20 characters.

    /* Fuel System Configurations */
    pump_service = true; //Allow users to use pump service on the map. Default = false
    fuel_cost = 6; //Cost of fuel per liter at fuel stations (if not defined for the vehicle already).
    ...
    gang_price = 55000; //Gang creation price. --Remember they are persistent so keep it reasonable to avoid millions of gangs.
    gang_upgradeBase = 15000; //The base cost for purchasing additional slots in a gang
    ...
    hospital_heal_fee = 115; //Fee to heal at a hospital NPC
    ...
    paycheck_civ = 3700; //Payment for civillians
    paycheck_med = 4200; //Payment for medics
    ...
    vehicle_storage_fee_multiplier = 0; //Garage storage and retrieval are free for every faction.
