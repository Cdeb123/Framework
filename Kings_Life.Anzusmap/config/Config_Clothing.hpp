...
class Clothing {
    ...
    class cop {
        ...
        uniforms[] = {
            ...
            { "U_B_CombatUniform_mcam_tshirt", "", 350, "['deputy'] call life_fnc_leoAtLeastRank" },
            { "U_B_CombatUniform_mcam_worn", "", 550, "['corporal'] call life_fnc_leoAtLeastRank" },
            { "U_B_survival_uniform", "", 1250, "['deputy'] call life_fnc_leoAtLeastRank" }
        };
        headgear[] = {
            { "NONE", $STR_C_Remove_headgear, 0, "" },
            { "H_Cap_police", "", 25, "" },
            { "H_Booniehat_mcamo", "", 120, "['deputy'] call life_fnc_leoAtLeastRank" },
            { "H_HelmetB_plain_mcamo", "", 75, "['deputy'] call life_fnc_leoAtLeastRank" },
            { "H_HelmetB_Enh_tna_F", "", 80, "['deputy'] call life_fnc_leoAtLeastRank" }, //Apex DLC
            { "H_Beret_blk_POLICE", "", 50, "['corporal'] call life_fnc_leoAtLeastRank" },
            { "H_MilCap_mcamo", "", 100, "['corporal'] call life_fnc_leoAtLeastRank" },
            { "H_MilCap_gen_F", "", 1200, "['corporal'] call life_fnc_leoAtLeastRank" }, //Apex DLC
            { "H_MilCap_tna_F", "", 1200, "['corporal'] call life_fnc_leoAtLeastRank" }, //Apex DLC
            { "H_MilCap_oucamo", "", 1200, "['corporal'] call life_fnc_leoAtLeastRank" }
        };
        goggles[] = {
            { "NONE", $STR_C_Remove_goggles, 0, "" },
            { "G_Squares", "", 10, "" },
        ...
        vests[] = {
            ...
            { "V_TacVest_blk_POLICE", "", 1000, "['deputy'] call life_fnc_leoAtLeastRank" },
            { "V_TacVest_gen_F", "", 1000, "['deputy'] call life_fnc_leoAtLeastRank" }, //Apex DLC
            { "V_PlateCarrier2_rgr", "", 1500, "['corporal'] call life_fnc_leoAtLeastRank" }
        };
        backpacks[] = {
            { "NONE", $STR_C_Remove_backpacks, 0, "" },
            { "B_FieldPack_cbr", "", 500, "" },
