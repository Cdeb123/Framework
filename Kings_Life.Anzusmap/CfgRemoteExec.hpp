...
class CfgRemoteExec {
    class Functions {
        ...
        F(life_fnc_applyLicenseAction,CLIENT)
        F(life_fnc_licenseAdminNotify,CLIENT)
        ...
        F(TON_fnc_updateHouseUpgrades,SERVER)
        F(TON_fnc_craftingVehicleCreate,SERVER)
        ...
        F(HC_fnc_updateHouseUpgrades,HC)
        F(HC_fnc_updatePartial,HC)
        F(HC_fnc_updateRequest,HC)
        F(HC_fnc_craftingVehicleCreate,HC)
