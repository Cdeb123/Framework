...
*/
private ["_housePos","_query","_upgrades"];
params [
    ["_uid","",[""]],
...
_upgrades = [[]] call DB_fnc_mresArray;

_query = format ["INSERT INTO houses (pid, pos, owned, upgrades) VALUES('%1', '%2', '1', '%3')",_uid,_housePos,_upgrades];
