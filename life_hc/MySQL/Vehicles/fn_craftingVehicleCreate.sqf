...
private _garageSideSql = [_garageSide] call HC_fnc_mresString;
private _classSql = [_className] call HC_fnc_mresString;
private _typeSql = [_type] call HC_fnc_mresString;
private _uidSql = [_uid] call HC_fnc_mresString;
private _characterSql = [_characterUid] call HC_fnc_mresString;
